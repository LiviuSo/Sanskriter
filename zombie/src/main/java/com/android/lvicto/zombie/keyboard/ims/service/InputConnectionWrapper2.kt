...
import com.android.lvicto.zombie.keyboard.ims.Constants
import com.android.lvicto.zombie.keyboard.ims.KeyListeners.BaseTouchListener.Companion.LOG_TAG
...
class InputConnectionWrapper2( var ic: InputConnection? = null,
    ...
    fun isBeginningOfSentence(): Boolean {
        ...
        Log.d(LOG_TAG, "isBeginningOfSentence(): [$beforeText]")
