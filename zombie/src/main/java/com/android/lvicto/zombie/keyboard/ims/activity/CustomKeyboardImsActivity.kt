package com.android.lvicto.zombie.keyboard.ims.activity
...
import kotlinx.android.synthetic.main.activity_customs_keyboard_test.*

class CustomKeyboardImsActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_customs_keyboard_test)
