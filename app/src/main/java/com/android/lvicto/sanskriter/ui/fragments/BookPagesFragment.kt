 ...
 * [BookPagesFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [BookPagesFragment.newInstance] factory method to
...
class BookPagesFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment BookPagesFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                BookPagesFragment().apply {
